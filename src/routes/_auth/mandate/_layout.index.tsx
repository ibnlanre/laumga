  ...
  return (
    <div className="relative flex-1 flex w-full flex-col overflow-hidden bg-[#f8faf4] text-gray-900">
      <section className="relative isolate overflow-hidden bg-linear-to-b from-[#05150d] via-deep-forest to-[#0f351f] text-white pt-6 sm:pt-8">
        ...
        <div className="relative container mx-auto grid gap-12 px-4 py-28 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
          <div>
      ...
      <main>
        <section className="bg-white py-20 md:py-28">
          <div className="container mx-auto grid gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:px-8 items-center">
            <div>
        ...
        <section className="bg-white py-20 md:py-28">
          <div className="container mx-auto flex flex-col gap-10 px-4 sm:px-6 lg:flex-row lg:px-8">
            {momentum.map((item) => (
              <div
                key={item.step}
