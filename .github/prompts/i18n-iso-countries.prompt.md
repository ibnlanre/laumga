...
i18n for ISO 3166-1 country codes. We support Alpha-2, Alpha-3 and Numeric codes from ['Wikipedia: Officially assigned code elements'](http://en.wikipedia.org/wiki/ISO_3166-1#Officially_assigned_code_elements)
...
In case you want to add new language, please refer [ISO 639-1 table](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes).
...
You can check codes here: [https://www.iso.org/obp/ui/#home](https://www.iso.org/obp/ui/#home)
